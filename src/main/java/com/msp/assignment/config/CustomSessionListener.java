...
public class CustomSessionListener implements HttpSessionListener
{
	...
	{
    	System.out.println("Session created event CustomSessionListener : " + se.getSession().getAttribute("username"));
    ...
    public void sessionDestroyed(HttpSessionEvent se)
    {
    	...
    	String email = (String) se.getSession().getAttribute("username");
